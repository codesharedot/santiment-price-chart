...
r  = requests.get("https://coinmarketcap.com/currencies/nash-exchange/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('nash-exchange price from 2014')
