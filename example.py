...
r  = requests.get("https://coinmarketcap.com/currencies/waltonchain/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('waltonchain price from 2014')
