...
r  = requests.get("https://coinmarketcap.com/currencies/decentraland/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('decentraland price from 2014')
