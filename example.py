...
r  = requests.get("https://coinmarketcap.com/currencies/stasis-euro/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('stasis-euro price from 2014')
