...
r  = requests.get("https://coinmarketcap.com/currencies/matic-network/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('matic-network price from 2014')
