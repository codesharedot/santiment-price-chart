...
r  = requests.get("https://coinmarketcap.com/currencies/bytecoin-bcn/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('bytecoin-bcn price from 2014')
