...
r  = requests.get("https://coinmarketcap.com/currencies/dragon-coins/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('dragon-coins price from 2014')
