...
r  = requests.get("https://coinmarketcap.com/currencies/bitcoin-diamond/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('bitcoin-diamond price from 2014')
