...
r  = requests.get("https://coinmarketcap.com/currencies/wink-tronbet/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('wink-tronbet price from 2014')
