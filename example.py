...
r  = requests.get("https://coinmarketcap.com/currencies/maidsafecoin/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('maidsafecoin price from 2014')
